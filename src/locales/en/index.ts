export const en = {
  ...
  friends: {
    ...
    blockDesc: "You'll be able to block users here in the future. For now, just enjoy the good vibes!",
  },
  resetPassword: {
  ...
  cafeDetails: {
    ...
    address: "Koffiestraat 1, Rotterdam",
    description: "Cozy café with the best coffee in town. Come by for a delicious espresso or cappuccino and enjoy our homemade cakes.",
