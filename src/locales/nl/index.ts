export const nl = {
  ...
  invite: {
    ...
    errorEmail: 'Voer alsjeblieft je e-mailadres in.',
    errorAuth: 'Authenticatiefout. Probeer opnieuw in te loggen.',
    errorAccept: 'Kon de uitnodiging niet accepteren.',
    success: 'Jullie zijn nu vrienden! We sturen je door...',
    inviteFrom: '{{name}} wil vrienden met je worden!',
    joinPrompt: 'Sluit je aan bij Anemi Meets om samen jullie volgende koffie-avontuur te plannen.',
    loggedInAs: 'Je bent ingelogd als',
    accept: 'Accepteren & Vrienden worden',
    loginToAccept: 'Log in of meld je aan om de uitnodiging te accepteren.',
    signupAndAccept: 'Aanmelden om te accepteren',
    loginAndAccept: 'Inloggen om te accepteren',
  ...
  respond: {
    ...
    subtitle:
      'Je vriend(in) wil afspreken! Kies een tijd die voor jou werkt, vul je e-mailadres in en wij regelen de rest.',
    explanation: 'Door te accepteren, steun je lokale koffietentjes, één afspraak per keer! ☕️❤️',
    timeLabel: 'Kies een tijdslot:',
    emailLabel: 'Jouw e-mailadres',
    emailPlaceholder: 'jij@voorbeeld.com',
    updatesOptIn: 'Houd me op de hoogte van Anemi Meets',
    btn_confirm: 'Afspraak bevestigen',
    success_title: 'Afspraak bevestigd!',
    confirmed: 'Tot dan! ✨',
    confirmationEmail: 'Je ontvangt een bevestigingsmail met alle details.',
    cafe: 'Café',
    address: 'Adres',
    date: 'Datum',
    time: 'Tijd',
    allSuggestedTimes: 'Alle voorgestelde tijden',
    downloadCalendarFile: 'Toevoegen aan agenda',
    createAccount:
      'Wil je het de volgende keer nog makkelijker maken? Maak een gratis account aan!',
    createAccountBtn: 'Maak een gratis account',
    backToHome: 'Terug naar home',
    invalidInvitation: 'Deze uitnodigingslink is ongeldig.',
    expiredOrMissing: 'Deze uitnodigingslink is verlopen of niet meer geldig.',
    genericError: 'Er is iets misgegaan. Probeer het opnieuw.',
    missingInfo: 'Selecteer een tijd en vul je e-mailadres in.',
    linkValid15min: 'Let op: deze link is maar 15 minuten geldig!',
  },
  dashboard: {
    title: 'Jouw Dashboard',
    welcome: 'Welkom, {{name}}!',
    subtitle: 'Klaar voor een nieuw koffie-avontuur?',
    planMeetup: 'Plan een nieuwe meetup',
    soloAdventure: 'Ga op solo-avontuur',
    upcoming: 'Jouw avonturen',
    noUpcoming: 'Je hebt nog niks gepland. Tijd voor actie!',
    meetupWith: 'Meetup met een vriend',
    soloAdventureTitle: 'Solo-avontuur',
    settings: 'Instellingen',
    error: {
      session: 'Kon je sessie niet verifiëren. Log alsjeblieft opnieuw in.',
      profile: 'Kon je profiel niet laden.',
      meetups: 'Kon je meetups niet laden.',
      solo: 'Kon je solo-avonturen niet laden.',
    },
  },
  account: {
    title: 'Jouw Profiel',
    ...
    bio: 'Bio',
    gender: 'Geslacht',
    tastePreferences: 'Smaakvoorkeuren',
    ...
    passwordResetSent: 'Wachtwoordherstellink naar je e-mail verzonden!',
  ...
  solo: {
    title: 'Plan een Solo-avontuur',
    findTitle: 'Vind een Willekeurig Café',
    tags: 'Wat voor sfeer zoek je?',
    price: 'Prijsklasse',
    findButton: 'Vind een lokaal pareltje',
    listTitle: 'Alle Beschikbare Cafés',
    randomSuggestion: 'Onze willekeurige suggestie voor jou:',
    yourChoice: 'Jouw gekozen café:',
    scheduleTitle: 'Plan je avontuur',
    scheduleButton: 'Plan het & stuur mij een bevestiging',
    noMatchSuggestion:
      'Sorry, we konden geen café vinden met alle sferen die je zoekt, maar hier is een willekeurige suggestie!',
    success: 'Je avontuur bij {{cafe}} op {{date}} is ingepland!',
    successTimeSlot: 'Je avontuur bij {{cafe}} voor de {{timeSlot}} van {{date}} is ingepland!',
    orSelect: 'Of kies een café uit de onderstaande lijst',
    datePlaceholder: 'Wanneer is jouw avontuur?',
    error: {
      cafes: 'Oeps, kon de cafés niet laden.',
      noMatch:
        'Geen cafés gevonden die aan je filters voldoen. Probeer wat filters te verwijderen.',
      missingDateTime: 'Vergeet niet een datum en tijd te kiezen!',
    },
  },
  emoji: {
