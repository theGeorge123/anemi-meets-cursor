export const nl = {
  common: {
    ...
    contactIntro:
      'We horen graag van je! Heb je een vraag, een idee, of wil je gewoon hallo zeggen? Stuur ons hieronder een bericht ☕️✨',
    contactName: 'Jouw naam of bijnaam',
    contactEmail: 'Jouw e-mail (zodat we kunnen antwoorden)',
    contactMessage: 'Wat ligt er op je hart?',
    contactSend: 'Verstuur! 🚀',
    contactSuccess: 'Bedankt voor je bericht! We nemen snel contact met je op ☕️',
    contactError: 'Oeps! Er is iets misgegaan. Probeer het opnieuw!',
    namePlaceholder: 'bv. KoffieLiefhebber123',
    emailPlaceholder: 'jij@voorbeeld.com',
    messagePlaceholder: 'Vertel ons wat je op je hart hebt...',
