export const nl = {
  ...
  respond: {
    ...
    explanation:
      'Door te accepteren, steun je lokale koffietentjes, één afspraak per keer! ☕️❤️',
    ...
    createAccount: 'Wil je het de volgende keer nog makkelijker maken? Maak een gratis account aan!',
  ...
  solo: {
    title: 'Solo-avontuur',
    subtitle: 'Vind de perfecte plek voor je volgende solo-koffiemoment.',
    cityLabel: 'In welke stad ben je?',
    searchButton: 'Zoek Cafés',
    resultsTitle: 'Hier zijn een paar plekken...',
    noResults: 'Geen cafés gevonden die aan je zoekopdracht voldoen. Probeer je criteria te verbreden!',
    errorCities: 'Kon steden niet laden. Probeer het later opnieuw.',
    errorSearch: 'Er is een fout opgetreden bij het zoeken. Controleer je verbinding en probeer het opnieuw.',
    scheduleButton: 'Plan dit avontuur',
    scheduleSuccess: 'Avontuur gepland voor',
    errorDate: 'Selecteer een datum om je avontuur te plannen.',
    errorUser: 'Je moet ingelogd zijn om een avontuur te plannen.',
    errorSchedule: 'Kon het avontuur niet plannen. Probeer het opnieuw.',
  },
  emoji: {
