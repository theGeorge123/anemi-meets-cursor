    ...
    <footer aria-label="Site footer" className="w-full border-t border-primary-100 py-8 px-4 flex flex-col sm:flex-row justify-center items-center gap-6 text-sm text-gray-600 font-medium bg-white/90 mt-auto">
      <div className="flex flex-col sm:flex-row items-center justify-center gap-y-3 gap-x-6 w-full sm:w-auto">
        <div className="flex flex-wrap justify-center items-center gap-x-4 gap-y-2">
          <Link to="/contact" className="footer-link">{t('common.contact', 'Contact')}</Link>
          <Link to="/cookie-policy" className="footer-link">{t('common.cookies', 'Cookies')}</Link>
          <Link to="/privacy-policy" className="footer-link">{t('common.privacy', 'Privacy Policy')}</Link>
          <Link to="/terms" className="footer-link">{t('common.terms', 'Terms & Conditions')}</Link>
        </div>
      </div>
