...
const Footer = () => {
  ...
  return (
    <footer className="w-full border-t border-primary-100 py-8 px-4 flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6 text-sm text-gray-600 font-medium bg-white/90 mt-auto">
