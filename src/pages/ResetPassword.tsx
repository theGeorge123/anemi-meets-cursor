        ...
        <form onSubmit={handleSubmit} className="space-y-4 flex flex-col justify-between mt-2">
          <div>
            <label htmlFor="new-password" className="block text-lg font-medium text-gray-700 mb-2">
              <span className="text-2xl">🔒</span> {t('resetPassword.newPassword')}
            </label>
            <input
              type="password"
              id="new-password"
          ...
          <div>
            ...
            >
              <span className="text-2xl">🔒</span> {t('resetPassword.repeatPassword')}
            </label>
            <input
              type="password"
              id="confirm-password"
          ...
          >
            {status === 'loading' ? t('resetPassword.working') : t('resetPassword.setPassword')}
          </button>
        </form>
      </div>
    </main>
