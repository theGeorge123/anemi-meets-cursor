        ...
        <div className="min-h-screen bg-secondary-50 relative">
          ...
          <div className="abstract-bg">
            ...
            >
              ...
              <g opacity="0.13">
                <path
                  d="M80 120c0-12 10-22 22-22s22 10 22 22c0 12-22 28-22 28s-22-16-22-28z"
                  fill="#ff914d"
                />
                <path
                  d="M1360 820c0-8 7-15 15-15s15 7 15 15c0 8-15 18-15 18s-15-10-15-18z"
                  fill="#b2dfdb"
                />
                <path
                  d="M700 400c0-7 6-13 13-13s13 6 13 13c0 7-13 15-13 15s-13-8-13-15z"
                  fill="#c5cae9"
                />
              </g>
              <g opacity="0.10">
